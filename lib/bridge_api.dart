...
class FfiApiImpl implements FfiApi {
  final FfiApiPlatform _platform;
  factory FfiApiImpl(ExternalLibrary dylib) =>
      FfiApiImpl.raw(FfiApiPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory FfiApiImpl.wasm(FutureOr<WasmModule> module) =>
      FfiApiImpl(module as ExternalLibrary);
  FfiApiImpl.raw(this._platform);
  Future<int> timesFromRust(
      {required int left, required int right, dynamic hint}) {
...
class FfiApiPlatform extends FlutterRustBridgeBase<FfiApiWire> {
  FfiApiPlatform(ffi.DynamicLibrary dylib) : super(FfiApiWire(dylib));
...
class FfiApiWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  FfiApiWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  FfiApiWire.fromLookup(
